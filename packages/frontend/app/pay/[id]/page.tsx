...
import { Shield, CreditCard, Lock, CheckCircle, ArrowRight, ShoppingBag, X, Zap, Layers, Globe } from 'lucide-react';
                        ...
                        <div className="p-6 space-y-3">
                            ...
                            {paymentGroup === 'ngn' && (
                                <>
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Instant · Mobile Money · USSD</p>
                                            </div>
                                        </div>
                                    ...
                                    <button
                                        onClick={() => initPayment('flutterwave')}
                                        className="w-full p-5 rounded-2xl bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all flex items-center justify-between group shadow-sm"
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-left">
                                                <p className="font-black text-slate-900 leading-none mb-1">Card / Bank Transfer</p>
                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Debit Card · Bank · USSD</p>
                                            </div>
                                        </div>
                                        <ArrowRight className="w-5 h-5 text-slate-300 group-hover:text-slate-500 group-hover:translate-x-1 transition-all" />
                                    </button>
                            ...
                            {/* International (USD/EUR/GBP) options */}
                            {paymentGroup === 'international' && (
                                <>
                                    <button
                                        onClick={() => initPayment('airwallex')}
                                        className="w-full p-5 rounded-2xl bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all flex items-center justify-between group shadow-sm"
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-left">
                                                <p className="font-black text-slate-900 leading-none mb-1">International Card (Airwallex)</p>
                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Visa · Mastercard · Wire</p>
                                            </div>
                                        </div>
                                        <ArrowRight className="w-5 h-5 text-slate-300 group-hover:text-slate-500 group-hover:translate-x-1 transition-all" />
                                    </button>
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-left">
                                                <p className="font-black text-slate-900 leading-none mb-1">International Card (Flutterwave)</p>
                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Visa · Mastercard · Amex</p>
                                            </div>
                                        </div>
                                        <ArrowRight className="w-5 h-5 text-slate-300 group-hover:text-slate-500 group-hover:translate-x-1 transition-all" />
                                    </button>
                            ...
                            {paymentGroup === 'crypto' && (
                                <button
                                    onClick={() => { setShowMethods(false); cr.open(); }}
                                    className="w-full p-5 rounded-2xl bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all flex items-center justify-between group shadow-sm"
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-left">
                                            <p className="font-black text-slate-900 leading-none mb-1">Pay with {txn?.currency}</p>
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Multi-Chain · ChainRails</p>
                                        </div>
                                    </div>
                                    <ArrowRight className="w-5 h-5 text-slate-300 group-hover:text-slate-500 group-hover:translate-x-1 transition-all" />
                                </button>
