        ...
        <div className="min-h-screen bg-slate-50 font-inter selection:bg-emerald-100">
            ...
            <main className="relative z-10 max-w-lg mx-auto pt-10 pb-20 px-6">
                ...
                <div className="flex flex-col items-center mb-10 text-center">
                    <div className="w-14 h-14 bg-gradient-to-br from-green-400 to-[#16a34a] rounded-2xl flex items-center justify-center shadow-xl shadow-emerald-100 mb-4">
                    ...
                    <div className="p-8 bg-slate-50/50 border-t border-slate-100">
                        {isPaid ? (
                            ...
                            <button
                                ...
                                className={`w-full h-16 bg-[#16a34a] text-white font-black text-lg rounded-2xl shadow-xl shadow-emerald-200 flex items-center justify-center gap-3 transition-all active:scale-[0.98] ${initializing ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[#15803d]'}`}
                            >
                                {initializing ? (
                                    <>
                    ...
                    <div className="bg-white w-full max-w-sm rounded-[32px] overflow-hidden shadow-2xl animate-in slide-in-from-bottom-10 sm:slide-in-from-bottom-0 sm:zoom-in-95 duration-300">
                        ...
                        <div className="p-6 space-y-3">
                            <button
                                ...
                                className="w-full p-5 rounded-2xl border-2 border-emerald-50 hover:border-emerald-500 hover:bg-emerald-50/30 transition-all flex items-center justify-between group"
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-emerald-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-emerald-100 group-hover:scale-110 transition-transform">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-sky-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-sky-100 group-hover:scale-110 transition-transform">
                            ...
                            <button
                                ...
                                className="w-full p-5 rounded-2xl border-2 border-orange-50 hover:border-orange-500 hover:bg-orange-50/30 transition-all flex items-center justify-between group"
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-orange-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-orange-100 group-hover:scale-110 transition-transform">
                            ...
                            <div className="p-4 rounded-xl border border-dashed border-slate-200 opacity-60 flex items-center gap-4 grayscale">
                                <div className="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center text-slate-400">
                                    <CreditCard className="w-6 h-6" />
                                </div>
                                <div className="text-left">
                                    <p className="font-bold text-slate-900 leading-none mb-1">Direct Bank Wire</p>
